      ...
      rec {
        nvidiaDrivers = (linuxPackages.nvidia_x11.override { }).overrideAttrs (oldAttrs: rec {
          ...
          src =
            ...
            in
            if sha256 != null then fetchurl { inherit url sha256; } else fetchurl { inherit url; };
          useGLVND = true;
        ...
        _nvidiaVersionFile =
          if nvidiaVersionFile != null then
            ...
            runCommand "impure-nvidia-version-file" {
              ...
              time = if builtins ? currentTime then builtins.currentTime else 0;
        ...
        nvidiaVersionAuto =
          if nvidiaVersion != null then
            ...
            let
              ...
              versionMatch = builtins.match ".*  ([0-9]+\\.[0-9]+\\.[0-9]+)  .*" data;
            in
